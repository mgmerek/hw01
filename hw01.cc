...

{
    ...
    double final_price;
    final_price = monitor_price * quantity;

    double discount_price;
    discount_price = final_price - (final_price * 0.05);
    double total_price;
    ...
    tax_price = (monitor_price * quantity * OHIO_TAX);
    ...
    if (quantity >= 3)
    {
        if (resident == "yes")
        {
            discounted_final_price = discount_price + tax_price;
        }
        if (resident == "no")
        {
            discounted_final_price = discount_price;
        }
    }
    ...
    if (quantity >= 3)
    {
        cout << "Discount: $" << (monitor_price * quantity) * (.05) << endl;
    }
    else
    {
    ...
    if (quantity >= 3)
    {
        if (resident == "yes")
        {
            cout << "Subtotal: $" << discount_price + tax_price << endl;
        }

        if (resident == "no")
        {
            cout << "Subtotal: $ " << discounted_final_price << endl;
        }
    }
    if (quantity < 3)
    {
